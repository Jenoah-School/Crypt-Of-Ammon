...
namespace GXPEngine.Core
{
    public class Collider
    {
        ...
        /// <summary>
        /// If a collision is or will happen, it will resolve the collision
        /// </summary>
        /// <param name="other">The collider to resolve the collision with</param>
        public virtual void ResolveCollision(Collision other)
        {
            return;
        }
    }
